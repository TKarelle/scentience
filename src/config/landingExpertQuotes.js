import nicolaClaytonPhoto from "../image/Professor Nicola Clayton.png";
import lisaHipgravePhoto from "../image/Lisa Hipgrave.png";
import barrySmithPhoto from "../image/Barry C. Smith.png";
  ...
  experts: [
    {
      ...
      affiliation: "IFRA UK",
      role:
        "Director of the International Fragrance Association UK (IFRA UK) and a highly respected fragrance industry specialist with decades of experience in perfumery, fragrance safety, regulation, and innovation.",
      quote:
    ...
    },
    {
      ...
      role:
        "Professor of Comparative Cognition at the University of Cambridge and Fellow of the Royal Society, renowned for her research into episodic memory, imagination, and how meaningful experiences become lasting memories.",
      quote:
    ...
    },
    {
      ...
      role:
        "Director of the Centre for the Study of the Senses, University of London. An internationally recognised philosopher of the senses whose research explores olfaction, flavour perception, and the unique relationship between smell, memory, and emotion.",
      quote:
        "Smell has a privileged connection to memory and emotion.",
      attribution:
