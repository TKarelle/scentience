/** Page « The process » — textes alignés maquette. */
...
export const THE_PROCESS_AMYGDALA_QUOTE =
  "THE SENSE OF SMELL IS THE ONLY SENSE CONNECTED DIRECTLY TO THE AMYGDALA — THE SEAT OF EMOTIONAL MEMORY. AN ODOR DOES NOT PASS THROUGH THE COGNITIVE FILTER. SHE TELEPORTS.";

export const THE_PROCESS_INGREDIENTS = {
  title: "The ingredients",
  subtitle:
    "Your destination is the brief. The landscape becomes the formula.",
  body:
    "When you tell us your journey — a honeymoon in Amalfi, a milestone anniversary in Kyoto, a night in Marrakech that refused to end — we begin building your formula from the raw materials of that specific region, that specific season, that specific emotional intention.",
