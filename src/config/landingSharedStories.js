/**
 * Placeholder testimonials — grounded voice, specific details (replace with real quotes later).
 *
 * `stories` est la source unique : landing (`SharedStoriesSection`) et page Project Proust
...
export const SHARED_STORIES_COPY = {
  ...
  stories: [
    ...
    },
    {
      ...
      place: "Porto",
      excerpt:
        "Our honeymoon still smells like salt on skin and that sharp little soap in the hotel bathroom. My husband wore something close by accident years later and I stood in the kitchen crying before I knew why.",
    },
    {
      id: "first-night",
      name: "Marc",
